...
function ensure_field_as_options(field, name) {
  if (field instanceof Fields.basefield) {
    ...
    field = Fields.basefield.normalize_field_shortcuts(field);
  }
  if (name) {
    field.name = name;
  }
...
class Model {
  ...
  static _make_model_class(opts) {
    ...
    class ModelClass extends this {
      ...
      static is_role_model = opts.is_role_model;
  ...
  static normalize(options) {
    ...
    for (const name of model.field_names) {
      ...
      if (!field) {
        ...
        const m_field = { ...pfield.get_options(), ...field };
        if (pfield.attrs || field.attrs) {
          m_field.attrs = { ...pfield.attrs, ...field.attrs };
        }
        field = m_field;
  ...
  static merge_field(a, b) {
    ...
    if (aopts.attrs || bopts.attrs) {
      options.attrs = { ...aopts.attrs, ...bopts.attrs };
    }
...
export default new Proxy(Model, {
  apply(target, thisArg, argumentsList) {
    return target.class(...argumentsList);
  },
});
